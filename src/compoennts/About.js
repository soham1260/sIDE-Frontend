  ...
  return (
    <div className='container' style={{ paddingTop: "1%" }}>
      ...
      <div className="row" style={{ width: '100%', paddingBottom: "3%" }}>
        ...
        <div style={{ height: "120px", display: "flex", alignItems: "center", color: "white" }}>
          <div className="col-md-10">BullMQ is a modern message queue and background job processing library for Node.js built on top of <b>Redis</b>. It is used for handling asynchronous tasks like sending emails, running scheduled jobs, or managing long-running workflows outside the main request/response cycle. In this project, BullMQ is used as a job queue to handle code execution asynchronously</div>
          <div className="col-md-2" style={{ display: "flex", justifyContent: "center" }}><img src={bullmq} alt="html" width="140px" /></div>
        </div>
